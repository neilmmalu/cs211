...
{
    int WriteMethod, count, i, j, cache_size, block_size;
    Cache cache;
    FILE *fp;
    ...
    cache =createCache(cache_size, block_size, WriteMethod);
...
Cache createCache(int cache_size,int block_size, int WriteMethod){
    Cache cache;
    int i = 0, lines;
